...
if [[ "${1-}" = "shell" ]]; then
    ...
    echo "entrypoint.sh:    loading data based on workload-cockroach..."
    /opt/ycsb/bin/ycsb load jdbc -P /opt/ycsb/workloads/workload-cockroach -P /opt/ycsb/conf/db.properties
